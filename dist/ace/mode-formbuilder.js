...
define("ace/mode/formbuilder_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
    ...
    var FormBuilderHighlightRules = function() {
        this.$rules = {
            ...
            fieldvalidations: [
                {
                    ...
                    regex: /^(\s*)(maxlength|minlength|min|max)(\s+)(\d+)/,
                    next: "fieldvalidations"
                },
                {
                    token: "keyword",
            ...
            fieldoptions: [  //some label | some value
                {
                    token: "keyword",
                    regex: /^\s*end options/,
                    next: "fielddef"
                ...
                {
                    token: ["text", "text", "keyword", "text", "keyword", "keyword"],
                    regex: /(\s*)([^|]+)(\s*\|\s*)([^|]+)(\s*\|\s*)(checked|selected)/,
                    next: "fieldoptions"
                },
                {
                    token: ["text", "text", "keyword", "keyword"],
                    regex: /(\s*)([^|]+)(\s*\|\s*)(checked|selected)/,
                    next: "fieldoptions"
                },
                {
                    token: ["text", "text", "keyword", "text"],
                    regex: /(\s*)([^|]+)(\s*\|\s*)(.+)/,
                    next: "fieldoptions"
                },
                {
    ...
    (function() {
        ...
        this.getNextLineIndent = function(state, line, tab) {
            ...
            if ((state === 'form' && /^(\s)*form(.)*$/i.test(line)) ||
                ...
                (state === 'fieldoptions' && /^(\s)*options(\s)*$/i.test(line))) {
                return indent + tab;
            }
        ...
        this.checkOutdent = function(state, line, input) {
            return ((state === 'fielddef' && /^(\s)*end validations(\s)*$/i.test(line)) ||
                ...
                (state === 'fieldoptions' && /^(\s)*end options(\s)*$/i.test(input))
            );
        };
