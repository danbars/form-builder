...
FIELD_PROPERTIES -> (ID | COMMENT | NAME | TYPE | REQUIRED | AUTOFOCUS| PLACEHOLDER | VALUE | HINT | LABEL | ICON | VALIDATIONS | AUTOCOMPLETE) {% function(d){return d[0][0]} %}
START_FIELD -> _ "field"i _ "\n"
END_FIELD -> _ "end field"i _ "\n"
TYPE -> _ "type"i __ ("textbox"i | "phone"i | "email"i | "url"i | "search"i | "number"i | "date"i | "time"i | "hidden"i | "textarea"i | "submit"i | "select"i | "combobox"i) _ "\n" {% function(d){return {key:"type", value:d[3][0]}} %}
