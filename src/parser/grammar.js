...
var grammar = {
    ...
    {"name": "TYPE$subexpression$2$subexpression$7", "symbols": [/[dD]/, /[aA]/, /[tT]/, /[eE]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$7"]},
    {"name": "TYPE$subexpression$2$subexpression$8", "symbols": [/[tT]/, /[iI]/, /[mM]/, /[eE]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$8"]},
    {"name": "TYPE$subexpression$2$subexpression$9", "symbols": [/[hH]/, /[iI]/, /[dD]/, /[dD]/, /[eE]/, /[nN]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$9"]},
    {"name": "TYPE$subexpression$2$subexpression$10", "symbols": [/[tT]/, /[eE]/, /[xX]/, /[tT]/, /[aA]/, /[rR]/, /[eE]/, /[aA]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$10"]},
    {"name": "TYPE$subexpression$2$subexpression$11", "symbols": [/[sS]/, /[uU]/, /[bB]/, /[mM]/, /[iI]/, /[tT]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$11"]},
    {"name": "TYPE$subexpression$2$subexpression$12", "symbols": [/[sS]/, /[eE]/, /[lL]/, /[eE]/, /[cC]/, /[tT]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "TYPE$subexpression$2", "symbols": ["TYPE$subexpression$2$subexpression$12"]},
    {"name": "TYPE$subexpression$2$subexpression$13", "symbols": [/[cC]/, /[oO]/, /[mM]/, /[bB]/, /[oO]/, /[bB]/, /[oO]/, /[xX]/], "postprocess": function (d) {return d.join(""); }},
